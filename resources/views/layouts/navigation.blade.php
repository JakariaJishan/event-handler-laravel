                ...
                <div class="relative">
                    ...
                    <div x-show="open" @click.away="open = false"
                        ...
                        <ul class="py-1 text-sm text-gray-700">
                            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100">Notification 1</a></li>
                            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100">Notification 2</a></li>
                            <li><a href="#" class="block px-4 py-2 hover:bg-gray-100">Notification 3</a></li>
                        </ul>
                    </div>
                </div>
